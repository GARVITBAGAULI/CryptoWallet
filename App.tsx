  ...
  return (
    <NavigationContainer>
      ...
      <Stack.Screen name="LoginScreen" component={LoginScreen} />
        <Stack.Screen name="FirstScreen" component={walletExist?BottomTabScreen:CreateWalletScreen} />
        ...
        <Stack.Screen name="VerifyMnemonics" component={VerifyMnemonicsScreen}/>
